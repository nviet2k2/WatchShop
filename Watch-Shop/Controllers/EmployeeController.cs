...
namespace Watch_Shop.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery] PaginationQueryModel payload)
        {
            try
            {
                var result = await _employeeService.GetAll(payload);
        ...
        public async Task<IActionResult> Create(EmployeeDTO payload)
        {
            try
            {
                var result = await _employeeService.Create(payload);
        ...
        public async Task<IActionResult> Update(EmployeeDTO payload)
        {
            try
            {
                var result = await _employeeService.Update(payload);
                return Ok(new BaseResponseModel(result));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> DeleteMultipleItems(int[] ids)
        {
            try
            {
                var result = await _employeeService.DeleteMultiple(ids);
                return Ok(new BaseResponseModel(result));
            }
            catch (Exception ex)
            {
